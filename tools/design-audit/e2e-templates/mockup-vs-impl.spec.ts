...
const PAGES: PageDef[] = [
  ...
  { id: 'P09',             mockup: '_archive/09_review_done.html',      route: '/review/demo/done', pageRootSelector: '[data-testid="review-done-page"]',     tolerance: 0.05 },
  { id: 'P10',             mockup: '_archive/10_calendar_month.html',   route: '/calendar',        pageRootSelector: '[data-testid="calendar-month-page"]',   tolerance: 0.05 },
