...
生成时间: 2026-05-04T18:39:42.233Z

| FE endpoint | BE controller | Gateway route | 状态 |
|---|---|---|---|
| GET /api/calendar/events | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| GET /api/guest/quota | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| GET /api/landing/kpi | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| GET /api/landing/samples | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| GET /api/review/nodes/:id/result | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| GET /api/review/today | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| GET /api/share/:id | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| GET /api/v1/ai-models | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| GET /api/v1/me/tier | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| GET /api/wb/questions/:id | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| PATCH /api/events/:id/ack | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| POST /api/analytics/event | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| POST /api/calendar/events/:id/subscribe | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| POST /api/file/presign | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| POST /api/guest/analyze | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| POST /api/review/nodes/:id/grade | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| POST /api/review/nodes/:id/open | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| POST /api/review/nodes/:id/reveal | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| POST /api/review/sessions/:id/next | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| POST /api/v1/me/ai-model | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
| POST /api/wb/questions/:id/save | ❌ 缺 | ❌ 缺 | ❌ 全缺 |
...
## Gateway Routes
- `/api/v1/wrongbook/**` → http://localhost:8081 (wrongbook-api)
- `/api/v1/ai/**` → http://localhost:8082 (ai-api)
- `/api/v1/review/**` → http://localhost:8083 (review-api)
- `/api/v1/file/**` → http://localhost:8084 (file-api)
- `/api/v1/anon/**` → http://localhost:8085 (anon-api)