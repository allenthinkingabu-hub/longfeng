...
/**
 * Minimal Snowflake id generator (S1 A2 override) — 41 bits timestamp + 10 bits worker + 12 bits
 * sequence. Enough for dev/test; production would swap in a centralized id service.
 */
@Component
