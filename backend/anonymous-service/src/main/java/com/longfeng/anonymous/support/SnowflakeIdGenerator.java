...
/**
 * Snowflake ID generator · anonymous-service · same layout as review-plan-service / wrongbook.
 *
 * <p>worker-id defaults to 5 (reserved for anonymous-service in plan §4 port allocation).
 */
@Component
public class SnowflakeIdGenerator {
  ...
  public SnowflakeIdGenerator(@Value("${snowflake.worker-id:5}") long workerId) {
